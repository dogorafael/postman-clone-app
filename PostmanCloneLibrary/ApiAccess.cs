...
public class ApiAccess : IApiAccess
{
    ...
    public async Task<string> CallApiAsync(string url, HttpContent? content, HttpAction action = HttpAction.GET, bool formatOutput = true)
    {
    ...
    public bool IsValidUrl(string url)
    {
        ...
        bool isValid = Uri.TryCreate(url, UriKind.Absolute, out Uri uriOutput) && uriOutput.Scheme == Uri.UriSchemeHttps;
